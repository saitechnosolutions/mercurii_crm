        ...
        <div class="container form-card">
            ...
            <form class="myForm" method="POST" action="{{ route('products.store') }}">
                <div class="row mb-4">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-2">
                            <label for="exampleFormControlInput1" class="form-label">Product Description <span
                                    style="color:red">*</span></label>
                            <textarea name="productdes" class="form-control" placeholder="Product Description"
                                required></textarea>
                        </div>
                    </div>
