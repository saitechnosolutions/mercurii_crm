...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="dasboard-welcome-card">
                <div class="dashboard">
                    <h3><b>Hi, {{ Auth::user()->name }} </b></h3>
                    <p><b>Ready to start your day with some pitch decks?</b></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5" >
                    ...
                    <div class="row align-items-center">
                        <div class="col-6">
                            ...
                            <h4 class="mb-3">
                                ...
                                <span class="counter-value" style="color:#fff;" data-target="0">0</span>
                            </h4>
                        </div>
                    </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-70" style="background:#643378;border-radius:15px;height: 90px;">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-70" style="background:#366a7d;border-radius:15px;height: 90px;">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class=" mb-3 lh-1 d-block text-truncate" style="color:#fff;">Overdue</span>
                            <h4 class="mb-3">
                                <span class="counter-value" data-target="0" style="color:#fff;">0</span>
                            </h4>
                        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-70" style="background:#225885;border-radius:15px;height: 90px;">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class=" mb-3 lh-1 d-block text-truncate" style="color:#fff;">Next 7 Days</span>
                            <h4 class="mb-3">
                                <span class="counter-value" data-target="0" style="color:#fff;">0</span>
                            </h4>
                        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-100 lead-card"
                 style="background:#fff;border-radius:15px;height: 90px;
                        box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;"
                 data-bs-toggle="modal" data-bs-target="#leadsModal">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class="mb-3 lh-1 d-block text-truncate" style="color:#000;">Total Leads</span>
                            <h4 class="mb-3">
                                <span class="" style="color:#000;">{{ $totalLeads }}</span>
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        @foreach($leadsstatus as $leadsta)
        @php
$modalId = 'Modal' . str_replace(' ', '_', $leadsta->dropdowndata);
@endphp
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-100 lead-card"
                 style="background:#fff;border-radius:15px;height: 90px;
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class="mb-3 lh-1 d-block text-truncate" style="color:#000;">{{ $leadsta->dropdowndata }}</span>
                            <h4 class="mb-3">
                                <span class="" style="color:#000;">{{ $leadsta->lead_count }}</span>
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class="text-muted mb-3 lh-1 d-block text-truncate">Warm Leads</span>
                            <h4 class="mb-3">
    ...
    <div class="row">
        <h2 class="card-title me-2">Leads Source Summary</h2>
        @foreach($leads as $lead)
        @php
        $modalId = 'Modal' . str_replace(' ', '_', $lead->dropdowndata);
        @endphp
        <div class="col-xl-3 col-md-6">
            ...
            <div class="card card-h-100 lead-card"
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class="mb-3 lh-1 d-block text-truncate" style="color:#000;">{{ $lead->dropdowndata }}</span>
                            <h4 class="mb-3">
                                <span class="" style="color:#000;">{{ $lead->lead_count }}</span>
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        {{-- <div class="col-xl-3 col-md-6">
            <div class="card card-h-100">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <span class="text-muted mb-3 lh-1 d-block text-truncate">New Leads</span>
                            <h4 class="mb-3">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="leadsModalLabel">All Leads</h5>
...
$modalId = 'Modal' . str_replace(' ', '_', $leadsta->dropdowndata);
@endphp
    <div class="modal fade" id="Modal{{ $modalId }}" tabindex="-1" aria-labelledby="ModalLabel{{ $leadsta->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel{{ $leadsta->id }}">{{ $leadsta->dropdowndata }} Leads</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        ...
                        <tbody>
                            @php
                                $filteredLeads = DB::table('leads')
                                    ->where('Leadstatus', $leadsta->id)
                                    ->leftJoin('dropdowndatas as source', 'leads.Leadsource', '=', 'source.id')
...
$modalId = 'Modal' . str_replace(' ', '_', $lead->dropdowndata);
@endphp
    <div class="modal fade" id="Modal{{ $modalId }}" tabindex="-1" aria-labelledby="ModalLabel{{ $lead->id }}" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel{{ $lead->id }}">{{ $lead->dropdowndata }} Leads</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <table class="table table-bordered">
